 ...
 * @version $Rev$ $Date$
 */
public class ProgramStartEvent extends CCEvent implements Serializable {

	private static final long serialVersionUID = -607863981372213815L;
	/**
	 * Creates an empty event to fill.
	 */
	public ProgramStartEvent() {
	}
	 ...
	 */
	public ProgramStartEvent(String headendID, String callsign, ScheduledProgram scheduledProgram, long timestamp) {
	 ...
	 * @param callsign the TV callsign from which these captions were read.
	 */
	public ProgramStartEvent(String headendID, String callsign) {
		super(headendID, callsign);
	}

	public String toString() {
		return "Program Start: "+getScheduledProgram();
	}
}
