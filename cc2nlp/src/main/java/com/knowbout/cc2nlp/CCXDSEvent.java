 ...
 * @version $Rev$ $Date$
 */
public class CCXDSEvent extends CCEvent implements Serializable {

	private static final long serialVersionUID = -607863981372213815L;
	private XDSData xdsData;
	private XDSField xdsField;
	 ...
	 */
	public CCXDSEvent(String headendID, String callsign, ScheduledProgram scheduledProgram, long timestamp,
			XDSData xds, XDSField change) {
		super(headendID, callsign, scheduledProgram, timestamp);
		this.xdsData = xds;
		this.xdsField = change;
	}
	 ...
	 * @param callsign the TV callsign from which these captions were read.
	 */
	public CCXDSEvent(String headendID, String callsign) {
		super(headendID, callsign);
	}

	public XDSField getXDSField() {
		return xdsField;
	}

	public void setXDSField(XDSField change) {
		this.xdsField = change;
	}
	...
	public void setXDSData(XDSData xds) {
		this.xdsData = xds;
	}
	
	public String toString() {
		return "Change: "+xdsField+", Data="+xdsData;
	}
}
